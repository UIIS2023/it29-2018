...
public class Circle extends SurfaceShape implements Serializable{
	...
	public Circle clone() {
		...
		Circle circle = new Circle(new Point(20, 20), 10, false, Color.RED, Color.BLACK);
	...
	public String toString() {
		return "Circle: center=( " + center.getX() + " , " + center.getY() + " ), radius= " + radius + " , inner color= " + getInnerColor().getRGB() + " , outer color: " + getColor().getRGB();
	}
