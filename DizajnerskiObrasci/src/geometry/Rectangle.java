...
public class Rectangle extends SurfaceShape implements Serializable{
	...
	public Rectangle clone () {
		Rectangle rectangle = new Rectangle(new Point(20, 20), 10, 10, false, Color.RED, Color.BLACK);
	...
	public String toString() {
		return "Rectangle: upper left point=( " + upperLeftPoint.getX() + " , " + upperLeftPoint.getY() + " ), width= " + width + " , height= " + height + " , inner color= " + getInnerColor().getRGB() + " , outer color= " + getColor().getRGB();
	}
